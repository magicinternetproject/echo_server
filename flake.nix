  ...
  outputs = {
      ...
      forAllSystems = function:
        nixpkgs.lib.genAttrs [
          ...
          "aarch64-darwin"
            ...
            echo_server = craneLib.buildPackage (craneCommon
              // {
    ...
    in {
      checks = forAllSystems ({
        ...
        echo_server-clippy = craneLib.cargoClippy (craneCommon
          // {
            inherit cargoArtifacts;
        ...
        # Check formatting
        echo_server-fmt = craneLib.cargoFmt {
          inherit src;
        };

        # Audit dependencies
        echo_server-audit = craneLib.cargoAudit {
      ...
      packages = forAllSystems ({ echo_server, ... }: {
        inherit echo_server;
        default = echo_server;
      });
      ...
      apps = forAllSystems ({system, ...}: {
        echo_server = {
          type = "app";
          program = "${self.packages.${system}.echo_server}/bin/echo_server";
        };
        default = self.apps.${system}.echo_server;
      });
